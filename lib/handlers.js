...
handlers.index = function(data,callback){
  ...
  if(data.method == 'get'){
    ...
    var templateData = {
      'head.title': 'Website uptime monitoring - made simple',
      'head.description': 'Get free and simple monitoring for HTTP/HTTPS sites of all kinds. When your site goes down, we\'ll send you a text to let you know.',
      'body.class': 'index'
    }
    console.log();
    ...
    helpers.getTemplate('index',templateData,function(err,str){
      if(!err && str){
        // Add the universal templates as a string
